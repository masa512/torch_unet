...
class Perceptual_loss(torch.nn.module):
	def __init__(self):
		...
		vgg16_block1 = torch.nn.Sequential(vision.models.vgg16(pretrained=True).features[:4].eval())
		vgg16_block2 = torch.nn.Sequential(vision.models.vgg16(pretrained=True).features[4:9].eval())
		vgg16_block3 = torch.nn.Sequential(vision.models.vgg16(pretrained=True).features[9:16].eval())
		vgg16_block4 = torch.nn.Sequential(vision.models.vgg16(pretrained=True).features[16:23].eval())
